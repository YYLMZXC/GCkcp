...
public class ServerChannelHandler extends ChannelInboundHandlerAdapter {
    ...
    public ServerChannelHandler
            (IChannelManager channelManager, ChannelConfig channelConfig, IMessageExecutorPool iMessageExecutorPool, KcpListener kcpListener, HashedWheelTimer hashedWheelTimer) {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object object) {
        ...
        if (ukcp == null) {// finished handshake
            ...
            if (waiter == null) {
                ...
                channelManager.newConnect(msg.sender(), newUkcp, msg);
