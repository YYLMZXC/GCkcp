...
public class ChannelConfig {
    ...
    //wheelTimer 定时器 default for 1 ms.
    private int useWheelTimer = 1;
    //接收窗口大小(字节 -1不限制)
    ...
    private IMessageExecutorPool iMessageExecutorPool
            = new NettyMessageExecutorPool(Runtime.getRuntime().availableProcessors() * 2);
    ...
    public int getUseWheelTimer() {
        return useWheelTimer;
    }
    ...
    public void setUseWheelTimer(int useWheelTimer) {
        this.useWheelTimer = useWheelTimer;
    }
